...
type SearchO_Object_Intern struct {
	...
	Stts bool `protobuf:"varint,300,opt,name=stts,proto3" json:"stts,omitempty"`
	// subs is the ID of the subscription being searched.
...
func (x *SearchO_Object_Intern) GetStts() bool {
	if x != nil {
		return x.Stts
	}
	return false
...
var file_pbf_subscription_search_proto_rawDesc = []byte{
	...
	0x28, 0x08, 0x52, 0x04, 0x73, 0x74, 0x74, 0x73, 0x12, 0x13, 0x0a, 0x04, 0x73, 0x75, 0x62, 0x73,
