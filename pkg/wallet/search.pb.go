...
type SearchO_Object_Intern struct {
	...
	// wllt is the ID of the wallet being searched.
	Wllt string `protobuf:"bytes,300,opt,name=wllt,proto3" json:"wllt,omitempty"`
}
...
func (x *SearchO_Object_Public) GetMess() string {
	if x != nil {
		return x.Mess
	}
	return ""
...
func (x *SearchO_Object_Public) GetPubk() string {
	if x != nil {
		return x.Pubk
	}
	return ""
...
func (x *SearchO_Object_Public) GetSign() string {
	if x != nil {
		return x.Sign
	}
	return ""
...
var file_pbf_wallet_search_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x64, 0x12, 0x13, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72, 0x18, 0xc8, 0x01, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x04, 0x75, 0x73, 0x65, 0x72, 0x12, 0x13, 0x0a, 0x04, 0x77, 0x6c, 0x6c, 0x74,
	0x18, 0xac, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x77, 0x6c, 0x6c, 0x74, 0x22, 0x6a, 0x0a,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6b, 0x69, 0x6e, 0x64, 0x12, 0x13, 0x0a, 0x04, 0x6d, 0x65,
	0x73, 0x73, 0x18, 0xc8, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6d, 0x65, 0x73, 0x73, 0x12,
	0x13, 0x0a, 0x04, 0x70, 0x75, 0x62, 0x6b, 0x18, 0xac, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04,
	0x70, 0x75, 0x62, 0x6b, 0x12, 0x13, 0x0a, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x18, 0x90, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x04, 0x73, 0x69, 0x67, 0x6e, 0x42, 0x0b, 0x5a, 0x09, 0x2e, 0x2f, 0x3b,
...
var file_pbf_wallet_search_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_pbf_wallet_search_proto_goTypes = []interface{}{
	...
	(*SearchO_Object_Public)(nil),   // 10: wallet.SearchO_Object_Public
}
var file_pbf_wallet_search_proto_depIdxs = []int32{
	...
	10, // 8: wallet.SearchO_Object.public:type_name -> wallet.SearchO_Object_Public
