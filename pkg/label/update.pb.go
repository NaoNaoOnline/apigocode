...
var file_pbf_label_update_proto_rawDesc = []byte{
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x2e, 0x55, 0x70, 0x64,
	...
	0x09, 0x52, 0x04, 0x6c, 0x61, 0x62, 0x6c, 0x22, 0x5c, 0x0a, 0x15, 0x55, 0x70, 0x64, 0x61, 0x74,
	...
	0x01, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x2e, 0x55, 0x70, 0x64, 0x61,
	...
	0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x42, 0x0a, 0x5a, 0x08, 0x2e, 0x2f, 0x3b, 0x6c, 0x61, 0x62,
...
var file_pbf_label_update_proto_goTypes = []interface{}{
	...
	(*UpdateO)(nil),               // 5: label.UpdateO
	(*UpdateO_Filter)(nil),        // 6: label.UpdateO_Filter
	(*UpdateO_Object)(nil),        // 7: label.UpdateO_Object
	(*UpdateO_Object_Intern)(nil), // 8: label.UpdateO_Object_Intern
	(*UpdateO_Object_Public)(nil), // 9: label.UpdateO_Object_Public
}
var file_pbf_label_update_proto_depIdxs = []int32{
	...
	6, // 4: label.UpdateO.filter:type_name -> label.UpdateO_Filter
	7, // 5: label.UpdateO.object:type_name -> label.UpdateO_Object
	8, // 6: label.UpdateO_Object.intern:type_name -> label.UpdateO_Object_Intern
	9, // 7: label.UpdateO_Object.public:type_name -> label.UpdateO_Object_Public
...
func file_pbf_label_update_proto_init() {
	...
	file_pbf_label_update_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
