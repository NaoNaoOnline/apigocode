...
const (
	API_Create_FullMethodName = "/label.API/Create"
	API_Delete_FullMethodName = "/label.API/Delete"
	API_Search_FullMethodName = "/label.API/Search"
	API_Update_FullMethodName = "/label.API/Update"
)
