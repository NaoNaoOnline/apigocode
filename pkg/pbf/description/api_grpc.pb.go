...
const (
	API_Create_FullMethodName = "/description.API/Create"
	API_Delete_FullMethodName = "/description.API/Delete"
	API_Search_FullMethodName = "/description.API/Search"
	API_Update_FullMethodName = "/description.API/Update"
)
...
var API_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pbf/description/api.proto",
}
