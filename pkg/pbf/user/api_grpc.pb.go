...
const (
	API_Create_FullMethodName = "/user.API/Create"
	API_Delete_FullMethodName = "/user.API/Delete"
	API_Search_FullMethodName = "/user.API/Search"
	API_Update_FullMethodName = "/user.API/Update"
)
