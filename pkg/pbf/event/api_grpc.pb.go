...
const (
	API_Create_FullMethodName = "/event.API/Create"
	API_Delete_FullMethodName = "/event.API/Delete"
	API_Search_FullMethodName = "/event.API/Search"
	API_Update_FullMethodName = "/event.API/Update"
)
