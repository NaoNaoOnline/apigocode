...
func (x *DeleteI) Reset() {
	*x = DeleteI{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbf_rule_delete_proto_msgTypes[0]
...
func (*DeleteI) Descriptor() ([]byte, []int) {
	return file_pbf_rule_delete_proto_rawDescGZIP(), []int{0}
}
...
func (x *DeleteI_Filter) Reset() {
	*x = DeleteI_Filter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbf_rule_delete_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteI_Filter) Descriptor() ([]byte, []int) {
	return file_pbf_rule_delete_proto_rawDescGZIP(), []int{1}
}
...
func (x *DeleteI_Object) Reset() {
	*x = DeleteI_Object{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbf_rule_delete_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteI_Object) Descriptor() ([]byte, []int) {
	return file_pbf_rule_delete_proto_rawDescGZIP(), []int{2}
}
...
type DeleteI_Object_Intern struct {
	...
	Rule string `protobuf:"bytes,100,opt,name=rule,proto3" json:"rule,omitempty"`
}

func (x *DeleteI_Object_Intern) Reset() {
	*x = DeleteI_Object_Intern{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbf_rule_delete_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteI_Object_Intern) Descriptor() ([]byte, []int) {
	return file_pbf_rule_delete_proto_rawDescGZIP(), []int{3}
}

func (x *DeleteI_Object_Intern) GetRule() string {
	if x != nil {
		return x.Rule
	}
	return ""
...
func (x *DeleteI_Object_Public) Reset() {
	*x = DeleteI_Object_Public{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbf_rule_delete_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteI_Object_Public) Descriptor() ([]byte, []int) {
	return file_pbf_rule_delete_proto_rawDescGZIP(), []int{4}
}
...
func (x *DeleteO) Reset() {
	*x = DeleteO{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbf_rule_delete_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteO) Descriptor() ([]byte, []int) {
	return file_pbf_rule_delete_proto_rawDescGZIP(), []int{5}
}
...
func (x *DeleteO_Filter) Reset() {
	*x = DeleteO_Filter{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbf_rule_delete_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteO_Filter) Descriptor() ([]byte, []int) {
	return file_pbf_rule_delete_proto_rawDescGZIP(), []int{6}
}
...
func (x *DeleteO_Object) Reset() {
	*x = DeleteO_Object{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbf_rule_delete_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteO_Object) Descriptor() ([]byte, []int) {
	return file_pbf_rule_delete_proto_rawDescGZIP(), []int{7}
}
...
func (x *DeleteO_Object_Intern) Reset() {
	*x = DeleteO_Object_Intern{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbf_rule_delete_proto_msgTypes[8]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteO_Object_Intern) Descriptor() ([]byte, []int) {
	return file_pbf_rule_delete_proto_rawDescGZIP(), []int{8}
}
...
func (x *DeleteO_Object_Public) Reset() {
	*x = DeleteO_Object_Public{}
	if protoimpl.UnsafeEnabled {
		mi := &file_pbf_rule_delete_proto_msgTypes[9]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DeleteO_Object_Public) Descriptor() ([]byte, []int) {
	return file_pbf_rule_delete_proto_rawDescGZIP(), []int{9}
}

var File_pbf_rule_delete_proto protoreflect.FileDescriptor

var file_pbf_rule_delete_proto_rawDesc = []byte{
	0x0a, 0x15, 0x70, 0x62, 0x66, 0x2f, 0x72, 0x75, 0x6c, 0x65, 0x2f, 0x64, 0x65, 0x6c, 0x65, 0x74,
	...
	0x18, 0xc8, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x72, 0x75, 0x6c, 0x65, 0x2e, 0x44,
	...
	0x1b, 0x2e, 0x72, 0x75, 0x6c, 0x65, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x49, 0x5f, 0x4f,
	...
	0x04, 0x72, 0x75, 0x6c, 0x65, 0x18, 0x64, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x72, 0x75, 0x6c,
	0x65, 0x22, 0x17, 0x0a, 0x15, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x49, 0x5f, 0x4f, 0x62, 0x6a,
	...
	0x64, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x72, 0x75, 0x6c, 0x65, 0x2e, 0x44, 0x65, 0x6c,
	...
	0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x72, 0x75, 0x6c, 0x65, 0x2e, 0x44, 0x65, 0x6c, 0x65,
	...
	0x18, 0x64, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x72, 0x75, 0x6c, 0x65, 0x2e, 0x44, 0x65,
	...
	0x75, 0x62, 0x6c, 0x69, 0x63, 0x18, 0xc8, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x72,
	0x75, 0x6c, 0x65, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f, 0x5f, 0x4f, 0x62, 0x6a, 0x65,
	0x63, 0x74, 0x5f, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x52, 0x06, 0x70, 0x75, 0x62, 0x6c, 0x69,
	0x63, 0x22, 0x2b, 0x0a, 0x15, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x4f, 0x5f, 0x4f, 0x62, 0x6a,
	...
	0x5f, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x3b, 0x72, 0x75,
	0x6c, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_pbf_rule_delete_proto_rawDescOnce sync.Once
	file_pbf_rule_delete_proto_rawDescData = file_pbf_rule_delete_proto_rawDesc
)

func file_pbf_rule_delete_proto_rawDescGZIP() []byte {
	file_pbf_rule_delete_proto_rawDescOnce.Do(func() {
		file_pbf_rule_delete_proto_rawDescData = protoimpl.X.CompressGZIP(file_pbf_rule_delete_proto_rawDescData)
	})
	return file_pbf_rule_delete_proto_rawDescData
}

var file_pbf_rule_delete_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_pbf_rule_delete_proto_goTypes = []interface{}{
	(*DeleteI)(nil),               // 0: rule.DeleteI
	(*DeleteI_Filter)(nil),        // 1: rule.DeleteI_Filter
	(*DeleteI_Object)(nil),        // 2: rule.DeleteI_Object
	(*DeleteI_Object_Intern)(nil), // 3: rule.DeleteI_Object_Intern
	(*DeleteI_Object_Public)(nil), // 4: rule.DeleteI_Object_Public
	(*DeleteO)(nil),               // 5: rule.DeleteO
	(*DeleteO_Filter)(nil),        // 6: rule.DeleteO_Filter
	(*DeleteO_Object)(nil),        // 7: rule.DeleteO_Object
	(*DeleteO_Object_Intern)(nil), // 8: rule.DeleteO_Object_Intern
	(*DeleteO_Object_Public)(nil), // 9: rule.DeleteO_Object_Public
}
var file_pbf_rule_delete_proto_depIdxs = []int32{
	1, // 0: rule.DeleteI.filter:type_name -> rule.DeleteI_Filter
	2, // 1: rule.DeleteI.object:type_name -> rule.DeleteI_Object
	3, // 2: rule.DeleteI_Object.intern:type_name -> rule.DeleteI_Object_Intern
	4, // 3: rule.DeleteI_Object.public:type_name -> rule.DeleteI_Object_Public
	6, // 4: rule.DeleteO.filter:type_name -> rule.DeleteO_Filter
	7, // 5: rule.DeleteO.object:type_name -> rule.DeleteO_Object
	8, // 6: rule.DeleteO_Object.intern:type_name -> rule.DeleteO_Object_Intern
	9, // 7: rule.DeleteO_Object.public:type_name -> rule.DeleteO_Object_Public
...
func init() { file_pbf_rule_delete_proto_init() }
func file_pbf_rule_delete_proto_init() {
	if File_pbf_rule_delete_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_pbf_rule_delete_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbf_rule_delete_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbf_rule_delete_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbf_rule_delete_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbf_rule_delete_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbf_rule_delete_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbf_rule_delete_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbf_rule_delete_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbf_rule_delete_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_pbf_rule_delete_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_pbf_rule_delete_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   10,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_pbf_rule_delete_proto_goTypes,
		DependencyIndexes: file_pbf_rule_delete_proto_depIdxs,
		MessageInfos:      file_pbf_rule_delete_proto_msgTypes,
	}.Build()
	File_pbf_rule_delete_proto = out.File
	file_pbf_rule_delete_proto_rawDesc = nil
	file_pbf_rule_delete_proto_goTypes = nil
	file_pbf_rule_delete_proto_depIdxs = nil
}
